/*================================================================
 React Component Composition
  ...
  arranged in the shape of a tree.
    ...
    What if there could be an opening and closing tag instead 
  for React elements too? Entering the concept of component composition:

    Component composition is one of React's more powerful features. 
  Essentially we'll discover how to use a React element in the same 
  fashion as an HTML element by leveraging its opening and closing tag.
...
import * as React from 'react';
 ...
 const App = () => { 
      ...
      //access the localstorage and assign value to searchTerm, setSearchTerm
